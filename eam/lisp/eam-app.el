...
;;;###autoload
(defun eam-prompt ()
  "Choose native history and show its latest user request."
  (interactive)
  ...
  (eam-native-history-open (eam-terminal-name eam-terminal--current)
                           (eam-terminal-directory eam-terminal--current) t))
...
clean up on quit, and return unverified metadata when the total deadline expires."
